...
print(b[0])
print(b[1])
print(b[0]*numpy.sqrt(4./3.) + b[1]*numpy.sqrt(1./3.))
c = numpy.dot(a,b)
print(c)
...
[[ 0.5        -0.5         0.          0.         -0.5         0.5       ]
 [ 0.28867513  0.28867513 -0.57735027 -0.57735027  0.28867513  0.28867513]]
[[ 1.        -0.5      ]
 [ 0.         0.8660254]]
[[ 1.        -0.5      ]
 [ 0.         0.8660254]]
...
int main(){
    ...
    getApqIJMatrixDims(int64_t Isomo, int64_t Jsomo, int64_t MS, int32_t *rowsout, int32_t *colsout){

    getApqIJMatrixDims(Isomo, Jsomo, MS, NMO,  &rows, &cols);
